...
def p_expresion_operaciones(t):
    ...
    if t[2] == '+':
        ...
        while i > 1:
            t[0] *= t[1]
            i -= 1
    elif t[2] == '+': #Esto es para el incremento de tres variables
        t[0]= t[1] + t[3] + t[5]
...
def p_declaracion_entero(t):
    'declaracion : T_ENTERO IDENTIFICADOR ASIGNAR expresion PUNTOCOMA'
    if isinstance(t[4], float):
        resultado = "Error semántico: no puedes asignar un número real a una variable ENTERO."
        print(resultado)
...
def p_declaracion_real(t):
    'declaracion : T_REAL IDENTIFICADOR ASIGNAR expresion PUNTOCOMA'
    nombres[t[2]] = t[4]

def p_declaracion_entero_sin_asignar(t):
    'declaracion : T_ENTERO IDENTIFICADOR PUNTOCOMA'
    nombres[t[2]] = 0

def p_declaracion_real_sin_asignar(t):
    'declaracion : T_REAL IDENTIFICADOR PUNTOCOMA'
    nombres[t[2]] = 0
